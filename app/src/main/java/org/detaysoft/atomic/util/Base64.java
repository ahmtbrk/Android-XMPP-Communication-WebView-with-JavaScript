...
/* ********  P R I V A T E   F I E L D S  ******** */
    ...
    private static byte WHITE_SPACE_ENC = -5; // Indicates white space in encoding
    private static byte EQUALS_SIGN_ENC = -1; // Indicates equals sign in encoding
...
/* ********  D E T E R M I N E   W H I C H   A L H A B E T  ******** */
	...
	{
		if( (options & 16) == 16 ) return _URL_SAFE_ALPHABET;
		else if( (options & 32) == 32 ) return _ORDERED_ALPHABET;
	...
	{
		if( (options & 16) == 16 ) return _URL_SAFE_DECODABET;
		else if( (options & 32) == 32 ) return _ORDERED_DECODABET;
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    public static boolean encodeToFile( byte[] dataToEncode, String filename )
    {
        ...
        try
        {
            bos = new Base64.OutputStream(
                      new java.io.FileOutputStream( filename ), 1 );
    ...
    public static boolean decodeToFile( String dataToDecode, String filename )
    {
        ...
        {
                bos = new Base64.OutputStream(
                          new java.io.FileOutputStream( filename ), 0);
